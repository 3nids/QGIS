...
class QgsSettingsEditorRegistry;
...
class GUI_EXPORT QgsGui : public QObject
{
  ...
  public:
    ...
    * \since QGIS 3.26
     ...
     * \since QGIS 3.32
     */
    static QgsSettingsEditorRegistry *settingsEditorRegistry() SIP_KEEPREFERENCE;
  ...
  private:
    ...
    QgsSettingsEditorRegistry *mSettingsEditorRegistry = nullptr;
