...
class GUI_EXPORT QgisInterface : public QObject
{
  ...
  public:
    ...
    */
     ...
     * \deprecated since QGIS 3.24 shape digitizing is now part of the add feature tool. To enable the shape tool, use QgsMapToolCapture::setCurrentCaptureTechnique and then QgsMapToolCapture::setCurrentShapeMapTool.
     */
