  ...
  , mExpressionContextScope( tr( "Map Canvas" ) )
{
  ...
  connect( QgsProject::instance()->advancedDigitizingGuideLayer(), &QgsMapLayer::repaintRequested, this, &QgsMapCanvas::layerRepaintRequested );
...
void QgsMapCanvas::refreshMap()
{
  ...
  allLayers.insert( 0, QgsProject::instance()->advancedDigitizingGuideLayer() );
