...
class CORE_EXPORT QgsGpsDetector : public QObject
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryEnumFlag settingsGpsStopBits = QgsSettingsEntryEnumFlag( QStringLiteral( "stop_bits" ), QgsSettings::Prefix::CORE_GPS, QSerialPort::OneStop ) SIP_SKIP;
    static const inline QgsSettingsEntryEnumFlag settingsGpsDataBits = QgsSettingsEntryEnumFlag( QStringLiteral( "data_bits" ), QgsSettings::Prefix::CORE_GPS, QSerialPort::Data8 ) SIP_SKIP;
