...
QString QgsCptCityArchive::defaultBaseDir()
{
  ...
  archiveName = QgsCptCityArchive::settingsCptCityArchiveName.value();
...
{
  *sDefaultArchiveName() = QgsCptCityArchive::settingsCptCityArchiveName.value();
...
void QgsCptCityArchive::initDefaultArchive()
{
  ...
  const QString baseDir = settings.value( QStringLiteral( "CptCity/baseDir" ),
                                          QString( QgsApplication::pkgDataPath() + "/resources" ) ).toString();
  // sub-dir defaults to
  const QString defArchiveName = QgsCptCityArchive::settingsCptCityArchiveName.value();
...
void QgsCptCityArchive::initArchives( bool loadAll )
{
  ...
  baseDir = settings.value( QStringLiteral( "CptCity/baseDir" ),
                            QString( QgsApplication::pkgDataPath() + "/resources" ) ).toString();
  // sub-dir defaults to
  defArchiveName = QgsCptCityArchive::settingsCptCityArchiveName.value();
