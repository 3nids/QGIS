...
class CORE_EXPORT QgsAuthManager : public QObject
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryBool settingsPasswordHelperLogging = QgsSettingsEntryBool( QStringLiteral( "password_helper_logging" ), QgsSettings::Prefix::AUTH_, false ) SIP_SKIP;
    static const inline QgsSettingsEntryBool settingsUsePasswordHelper = QgsSettingsEntryBool( QStringLiteral( "use_password_helper" ), QgsSettings::Prefix::AUTH_, true ) SIP_SKIP;
