...
bool QgsAuthManager::passwordHelperDelete()
{
  ...
  job.setInsecureFallback( QgsAuthManager::settingsPasswordHelperInsecureFallback.value() );
...
bool QgsAuthManager::passwordHelperEnabled() const
{
  ...
  return QgsAuthManager::settingsUsePasswordHelper.value();
}
...
{
  // Does the user want to store the password in the wallet?
  return QgsAuthManager::settingsPasswordHelperLogging.value();
}
