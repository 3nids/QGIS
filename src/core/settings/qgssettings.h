  ...
  public:
    ...
    class Prefix SIP_SKIP
    {
      public:
        ...
        static const inline char *BROWSER = "browser";
        static const inline char *GPS_ = "gps_";
        static const inline char *AUTH_ = "auth_";
        static const inline char *GDAL = "gdal";
        static const inline char *UI = "UI";
        static const inline char *PROXY = "proxy";
        static const inline char *CPTCITY = "CptCity";
        static const inline char *GUI_LAYOUTDESIGNER = "gui_LayoutDesigner";
        static const inline char *PROVIDERS_QGIS = "providers_qgis";
        static const inline char *NO_PREFIX = "";
        static const inline char *CORE_RENDERING = "core_rendering";
        static const inline char *RASTER = "Raster";
        static const inline char *CORE_GPS = "core_gps";
