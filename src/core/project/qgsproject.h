...
class QgsAdvancedDigitizingGuideLayer;
...
class CORE_EXPORT QgsProject : public QObject, public QgsExpressionContextGenerator, public QgsExpressionContextScopeGenerator, public QgsProjectTranslator
{
  ...
  public:
    ...
    */
     ...
     * \since QGIS 3.34
     */
    QgsAdvancedDigitizingGuideLayer *advancedDigitizingGuideLayer() SIP_SKIP;
  ...
  private:
    ...
    */
    ...
    QgsAdvancedDigitizingGuideLayer *mAdvancedDigitizingGuidesLayer = nullptr;
