...
QVector<QgsDataItem *> QgsFavoritesItem::createChildren()
{
  ...
  const QStringList favDirs = QgsSettingsRegistryCore::settingsBrowserFavourites.value();
...
void QgsFavoritesItem::addDirectory( const QString &favDir, const QString &n )
{
  ...
  QStringList favDirs = QgsSettingsRegistryCore::settingsBrowserFavourites.value();
