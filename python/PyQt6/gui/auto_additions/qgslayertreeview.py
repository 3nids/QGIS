...
try:
    ...
    QgsLayerTreeView.__overridden_methods__ = ['setModel', 'contextMenuEvent', 'mouseReleaseEvent', 'keyPressEvent', 'dragEnterEvent', 'dragMoveEvent', 'dragLeaveEvent', 'dropEvent', 'paintEvent', 'resizeEvent']
